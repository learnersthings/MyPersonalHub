...
export default function ReminderEditorScreen() {
    ...
    return (
        ...
        >
            ...
            <Text style={{ fontSize: 16, fontWeight: "600", marginBottom: 10, marginTop: 10, color: colors.text }}>
                Set Date & Time
            </Text>
            ...
            >
                <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8 }}>
                    ...
                    <Text style={globalStyles.buttonText}>{editingReminder ? "Update" : "Save"}</Text>
                </View>
            </TouchableOpacity>
